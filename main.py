...
def main():
    ...
    parser.add_argument("--encoder", type=str, default="medvit", choices=["simple_cnn", "timm_vit", "resnet3d", "medvit", "hybrid"], help="Encoder backbone")
    ...
    if args.mode == "train":
        ...
        encoder_config_for_save = None
        if args.encoder == "medvit":
            encoder_config_for_save = encoder_config
